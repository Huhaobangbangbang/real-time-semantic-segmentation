...
def example_flaw_edge(flaw_path):
    ...
    init_ls = ms.circle_level_set(img.shape, (500, 500), 200)
...
if __name__ == '__main__':
    flaw_path = '/Users/huhao/Library/Mobile Documents/com~apple~CloudDocs/picture/吴思瑶/WechatIMG77.jpeg' # (245, 256)

...
sys.path.append("/cloud_disk/users/huh/projects/realtime_semseg/DDRNet/segmentation/deeplabv3/")
...
if __name__== "__main__":
    ...
    network = DeepLabV3("eval_seq", project_dir="/cloud_disk/users/huh/projects/realtime_semseg/DDRNet/segmentation/deeplabv3/").cuda()
    network.load_state_dict(torch.load("/cloud_disk/users/huh/projects/realtime_semseg/DDRNet/segmentation/deeplabv3/training_logs/model_1/checkpoints/model_1_epoch_204.pth"))

    for sequence in ["00", "01", "02"]:
        print (sequence)
        val_dataset = DatasetSeq(cityscapes_data_path="/cloud_disk/users/huh/dataset/cityscapes",
                                cityscapes_meta_path="/cloud_disk/users/huh/dataset/cityscapes",
                                sequence=sequence)

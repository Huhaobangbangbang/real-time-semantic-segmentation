...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 50:
            ...
            resnet.load_state_dict(torch.load("/cloud_disk/users/huh/projects/realtime_semseg/DDRNet/segmentation/deeplabv3/pretrained_models/resnet/resnet50-19c8e357.pth"))
...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 18:
            resnet = models.resnet18()
            # load pretrained model:
            resnet.load_state_dict(torch.load("/cloud_disk/users/huh/projects/realtime_semseg/DDRNet/segmentation/deeplabv3/pretrained_models/resnet/resnet18-5c106cde.pth"))
